                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info waves-effect"
                                                onclick="update_language()">Speichern</button>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title black_color" id="myModalLabel"><i
                                                    class="fa fa-sticky-note"></i> Willkommenstext
                                                anlegen<br><small>Empfohlene Lange von max. 300 Zeichen</small></h4>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-hidden="true">×</button>
                                        </div>
                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Montag <small>(Standard, wenn andere Tage
                                                                            leer)</small></h6>
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Text einfügen" maxlength="300">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Dienstag</h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" id="mon_note_id_it"
                                                                        ...
                                                                        class="form-control mb-2"
                                                                        placeholder="Geben Sie Note auf Italienisch ein"
                                                                        maxlength="300">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Dienstag</h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" id="mon_note_id_de"
                                                                        ...
                                                                        class="form-control mb-2"
                                                                        placeholder="Hinweis auf Deutsch eingeben"
                                                                        maxlength="300">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Dienstag</h6>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info waves-effect"
                                                onclick="update_welcome_note()">Speichern</button>
                                            <button type="button" class="btn btn-default waves-effect"
                                                data-dismiss="modal">Abbrechen</button>
                                        </div>
                                    </div>
                                                ...
                                                if ($Edit_rules == 1 || $usert_id == 1) { ?>
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-10 col-xlg-10 col-md-9">
                                                                <h4 class="pt-3 black_color">Rollen verwalten</h4>
