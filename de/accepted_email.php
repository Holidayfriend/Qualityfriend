...
<head>
    ...
    <title>Automatische E-Mail bei Annahme</title>
    <!-- page CSS -->
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Automatische E-Mail bei Annahme</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="container-fluid mobile-container-pl-75 ">
                ...
                <div class="row page-titles heading_style">
                    <div class="col-md-5 align-self-center">
                        <h5 class="text-themecolor font-weight-title font-size-title mb-0">Automatische E-Mail bei Annahme</h5>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Recruiting </a></li>
                                <li class="breadcrumb-item text-success">Automatische E-Mail bei Annahme</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                        <div class="row pl-2 pr-2">
                                            <select id="template" class="select2 form-control custom-select">
                                                <option value="0">Wählen Sie Vorlage aus</option>
                                                <?php
                                        ...
                                        <div class="div-background  mt-4 p-4">
                                            <h6 class="red" >
                                            Verwenden <strong>{{name}}</strong> den Namen des Antragstellers einzufügen,
                                            ...
                                            <h4 class="font-weight-title">Thema</h4>
                                            ...
                                            <div class="row pt-4 ">
                                                <div class="col-lg-12 wm-70 col-xlg-12 col-md-12">
                                                    <h4 class="font-weight-title ">Körper</h4>
                                                </div>
