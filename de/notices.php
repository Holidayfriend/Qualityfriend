                    ...
                    <div class="col-lg-2 wm-48 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_notices == 1 || $usert_id == 1) { ?>
                            <a href="notice_create.php" class="btn  w-100 btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Notiz erstellen</a>
                        <?php } ?>
                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result10)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="label p-2 label-table label-success">Notiz
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu animated flipInY">
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            onclick="delete_notice('<?php echo $row[0]; ?>');">Löschen</a>
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            onclick="duplicate_notice('<?php echo $row[0]; ?>');">Duplikat</a>
                                                                        <a class="dropdown-item"
                                                                            href="notice_detail.php?id=<?php echo $row[0]; ?>">Aussicht</a>
                                                                        <a class="dropdown-item"
                                                                            href="notices_edit.php?id=<?php echo $row[0]; ?>">Bearbeiten</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        <?php } ?>
