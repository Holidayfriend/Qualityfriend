                            ...
                            <div class="list-background-second">
                                <select class=" form-control " onchange="change_data();"
                                    ...
                                    <option <?php if ($filter_table == $user_id)
                                        echo 'selected'; ?> value="<?php echo $user_id; ?>">Persönliches Protokoll</option>
                                    <?php
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"
                                                        class="border text-center"><b> Benutzer</b></th>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <b><?php echo date("d.m.Y", strtotime(substr($row[4], 0, 10)));
                                                            ; ?></b><br><span
