...
<head>
    ...
    <title>Alle – E-Mail-Vorlage </title>
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Alle – E-Mail-Vorlage</p>
        </div>
    </div>
    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="mobile-container-padding">
                    ...
                    if ($filter_table !== '') {
                        $sql .= "  WHERE (`template_type` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `template_name_de` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `subject_de`  LIKE '%" . $conn->real_escape_string($filter_table) . "%')";
                    }
                    ...
                    if ($filter_table !== '') {
                        $sqlCount .= " WHERE (`template_type` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `template_name_de` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `subject_de`  LIKE '%" . $conn->real_escape_string($filter_table) . "%')";
                    }
                    ...
                    <div class="mobile-container-padding">
                        <div class="row page-titles mb-3 heading_style">
                            <div class="col-md-3 align-self-center">
                                <h5 class="text-themecolor font-weight-title font-size-title mb-0">Alle – E-Mail-Vorlage
                                </h5>
                            </div>
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="javascript:void(0)">E-Mail-Automatisierung</a>
                                        </li>
                                        <li class="breadcrumb-item text-success">Alle – E-Mail-Vorlage</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12  col-md-12 mt-2 mb-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Meine Subdomain <small></small></h4>
                                <input value="<?php echo $sub_domain; ?>" type="text" id="sub_domain"
                                    class="form-control" placeholder="Sub Domain">

                                <h4 class="card-title mt-2">Antwort-E-Mail<small></small></h4>
                                <input value="<?php echo $reply_mail; ?>" type="text" id="reply_mail"
                                    class="form-control" placeholder="Antwort-E-Mail">

                                <h4 class="card-title mt-2">E-Mail-Logo <small></small></h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                <h4 class="card-title inline-div mtm-10 mbm-0">Vorlagen</h4>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr id="<?php echo $i; ?>">
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['template_name_de']; ?></td>
                                                        <td><?php echo $row['template_type']; ?></td>
                                                        <td><?php echo $row['subject_de']; ?></td>
                                                        <td><?php echo $row['body_de']; ?></td>
    ...
    <script>
        ...
        function save() {
            ...
            if (!sub_domain) {
                Swal.fire({
                    title: 'Subdomain ist erforderlich',
                    icon: 'warning',
