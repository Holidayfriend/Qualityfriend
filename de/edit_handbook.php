                                    ...
                                    <div class="row pt-4 small-screen-mr-16">
                                        <div class="col-lg-6 col-xlg-6 col-md-6 ">
                                            ...
                                            <div class="row pl-2 pr-2 mb-3">
                                                <label class="control-label mt-1"><strong>Sprache
                                                        hinzufügen</strong></label>
                                            ...
                                            <div class="div-background mt-4   p-4">
                                                ...
                                                <input type="text" id="title_id_de" class="form-control"
                                                    placeholder="Titel Eingeben" value="<?php echo $title_de ?>">
                                                <div class="row pt-4 ">
                                                ...
                                                <?php for ($i = 0; $i < sizeof($attach_id_array); $i++) { ?>
                                                    <div id="delete_<?php echo $attach_id_array[$i]; ?>">
                                                        <a data-toggle="tooltip"
                                                            data-original-title="Klicken Sie hier, um den Anhang anzuzeigen"
                                                            href="<?php echo $attach_url_array[$i]; ?>"
                                                            target="_blank"><?php echo 'Anhang-' . ($i + 1); ?></a><a
                                                            style="color:#f62d51;" data-toggle="tooltip"
                                                            data-original-title="
                                                            Anhang entfernen" href="javascript:void(0);"
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                                        <div>
                                                            <div class="div-background  p-4">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-10 wm-70 col-xlg-10 col-md-10">
                                                                        <h4 class="font-weight-title pt-4">Beschreibung
                                                                        </h4>
                                                                    </div>
                                                                    <div
                            ...
                            <div class="row mbm-20">
                                <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                    <input type="button" id="" onclick="save_handbook('CREATE');"
                                        class="btn mt-4 w-25 wm-48 btn-secondary" value="Änderungen speichern">
                                    <input type="button" id="" onclick="save_handbook('DRAFT');"
                                        class="btn mt-4 w-25 ml-1 wm-45  btn-outline-info"
                                        value="Als Entwurf speichern">
                                    <input type="button" id="" onclick="d(<?php echo $hdb_id; ?>)"
                                        class="btn mt-4 w-10 ml-1 wm-30  btn-outline-info" value="Löschen">
                                    <input type="button" id="" onclick="duplicate(<?php echo $hdb_id; ?>)"
                                        class="btn mt-4 wm-30 w-10 ml-1  btn-outline-info" value="Duplikat">

                                    <input type="button" id="" onclick="save_handbook('TEMPLATE');"
                                        class="btn mt-4 ml-1 w-25 wm-45 btn-outline-info btn-template"
                                        value="Als Vorlage speichern">

                                    <input type="button" id="" onclick="delete_template()"
                                        class="btn mt-4 ml-1 w-25 wm-43 btn-outline-info btn-delete"
                                        value="Vorlage löschen">
                                </div>
