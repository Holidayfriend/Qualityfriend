                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu mailbox animated bounceInDown" id="result_notifications">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="nav-link text-center m-b-5" href="dashboard.php"> <strong>Überprüfen Sie alle
                                        Benachrichtigungen</strong> <i class="fa fa-angle-right"></i> </a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox animated bounceInDown" aria-labelledby="2" id="result_msg">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center link m-b-5" href="chat.php"> <b>Alle Nachrichten
                                                anzeigen</b> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                            ...
                            src="<?php echo '.' . $profile_image; ?>" alt="user" class="img-circle"
                            width="30"><span id="firstNameSpan"><?php echo $first_name; ?></span></a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY"
                        ...
                        <a class="dropdown-item" href="user_profile.php"><i class="ti-user m-r-5 m-l-5"></i> Mein
                            Profil</a>
                            <a class="dropdown-item" href="pricing.php"><i class="mdi mdi-verified m-r-5 m-l-5"></i>Software aktualisieren</a>
                        <?php if ($Send_Receive_messages == 1 || $usert_id == 1) {
                            if ($chat_flag == 1) {
                                ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                            ...
                            <div class="px-3 py-3">
                                <h6 class="text-sm text-muted m-0"
                                    style="font-weight:bold;margin:0px;font-size: 1.0625rem;font-family: inherit;">Sprache
                                    wählen</h6>
                            </div>
                            <!-- List group -->
