                                ...
                                <div class="row pt-4 small-screen-mr-16">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                        ...
                                        <div class="div-background  mt-4 p-4">
                                            <h6 class="red">
                                                Verwenden <strong>{{name}}</strong> den Namen des Antragstellers
                                                einzufügen,
                                            ...
                                            <div class="form-check form-switch mt-4 p-4">
                                                <input <?php echo $check; ?> class="form-check-input" type="checkbox"
                                                    id="is_auto_on">
                                                <label class="form-check-label" for="is_auto_on">Bei Automatischer E-Mail</label>
                                            </div>
    ...
    <script>
        ...
        function saveed() {
            ...
            if (subject.trim() === "" || body.trim() === "") {
                ...
                Swal.fire({
                    title: 'Subjekt und Körper dürfen nicht leer sein!',
                    type: 'basic',
        ...
        $('#template').on('change', function () {
            ...
            if (template_id !== "0") {
                $.ajax({
                    ...
                    method: 'POST',
                    data: { template_id: template_id,by:'de' },
                    success: function (response) {
                        var data = JSON.parse(response);
