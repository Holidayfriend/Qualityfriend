                                    ...
                                    <div class="modal-content">
                                                            ...
                                                            <div class="col-md-12 m-b-20 mt-2">
                                                                <div id="div_name_en_sub_cat" class="form-group ">
                                                                    ...
                                                                    <input onkeyup="error_handle_sub('name')"
                                                                        ...
                                                                        id="sub_cat_name" placeholder="Name eingeben"
                                                                        required>

                                                                    <small id="error_msg_name_en_sub_cat"
                                                                        class="form-control-feedback display_none">Kategoriename
                                                            ...
                                                            <div class="col-md-12 m-b-20 mt-2">
                                                                <div class="row">
                                                                    <div class="col-md-10" id="refrash1">
                                                                        <label
                                                                            class="control-label"><strong>Category</strong></label>
                                                                        <div id="div_category" class="form-group ">
                                                                            ...
                                                                            <small id="error_msg_category"
                                                                                ...
                                                                                Kategorie ist erforderlich</small>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info waves-effect"
                                                onclick="save_sub_cat()">Speichern</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a type="submit" class="btn btn-info waves-effect" onclick="save_catagory()"
                                                data-toggle="modal" href="">Speichern</a>
                                            <a class="btn btn-default waves-effect" data-toggle="modal"
                                                data-target="#add-contact" href="" data-dismiss="modal">Abbrechen</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                                ...
                                <div class="row pt-4 small-screen-mr-16">
                                    ...
                                    <div class="col-lg-6 col-xlg-6 col-md-6 pl-5 plm-10px mtm-10">
                                        <div class="row mm-0">
                                            <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 pb-3">
                                                        <div
                                                            ...
                                                            <input value="PUBLIC" type="radio" id="public" name="public"
                                                ...
                                                <div class="row div-background p-4">
                                                    <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                        <label class="control-label"><strong>Abteilung
                                                ...
                                                <div class="row div-background p-4">
                                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                                        ...
                                                        <div class="tags-default">
                                                            <input type="text" name="tags" id="tags_id"
                                        ...
                                        <div class="row mm-0 pl-2 pr-2">
                                            <select id="language_id" disabled
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                        <input type="button" id="" onclick="save_handbook('CREATE');"
                                            class="btn mt-4 w-20 wm-30 btn-secondary" value="Erstellen">
                                        <input type="button" id="" onclick="save_handbook('DRAFT');"
                                            class="btn mt-4 w-20 ml-3 wm-45  btn-outline-info"
                                            value="Als Entwurf speichern">
                                        <input type="button" id="" onclick="save_handbook('TEMPLATE');"
                                            class="btn mt-4 ml-3 w-20 wm-45  btn-outline-info btn-template"
                                            value="Als Vorlage speichern">
                                        <input type="button" id="" onclick="d()"
                                            class="btn mt-4 ml-3 w-20 btn-outline-info wm-43 btn-delete"
