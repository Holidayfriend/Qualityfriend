...
<div class="form-group mb-0 black_color">
    <label class="control-label display-inline w-80 wm-50 black_color"><strong>Titel der Personalabteilung</strong></label>
    <label class="control-label display-inline w-18 wm-50 black_color"><strong>Aktion</strong></label>
</div>
<?php
