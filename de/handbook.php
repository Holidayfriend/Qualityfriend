                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_handbooks == 1 || $usert_id == 1) { ?>
                            <a href="create_handbook.php" class="btn btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Handbuch erstellen</a>
                        <?php } ?>
                    </div>
                    <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($Create_edit_handbooks == 1 || $usert_id == 1) { ?>
                                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4"
                                                            class="border text-center"><b> Aktionen</b></th>
                                                    <?php } ?>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu animated flipInY">
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            ...
                                                                            href="javascript:void(0)">Duplikat</a>
                                                                        <a class="dropdown-item"
                                                                            href="handbook_detail.php?id=<?php echo $row['hdb_id']; ?>">Aussicht</a>
                                                                        <a class="dropdown-item"
                                                                            href="edit_handbook.php?id=<?php echo $row['hdb_id']; ?>">Bearbeiten</a>
