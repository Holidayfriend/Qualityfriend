                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body small-screen-pr-0 mobile-container-pl-60">
                                ...
                                ?>
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-12 wm-72">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-12 wm-28  mt-3 mb-3 mt-md-0 mb-md-0">
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#add-contact"
                                            class="btn w-100 btn-secondary d-lg-block "><i
                                                class="fa fa-plus-circle"></i> Nutzer hinzufügen</a>
                                        ...
                                        <div class="modal-content">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <div class="col-md-12 m-b-20 mt-2">
                                                                <div onkeyup="error_handle_c('first_name')"
                                                                    id="div_first_name_c" class="form-group ">
                                                                    <input type="text" class="form-control"
                                                                        id="first_name" placeholder="Vorname*">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"
                                                    onclick="adduser()">Speichern</button>
                                ...
                                <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                            ...
                                                            <div class="col-md-12 m-b-20 mt-2">
                                                                <div id="div_first_name_e" class="form-group ">
                                                                    <input onkeyup="error_handle_e('first_name')"
                                                                        ...
                                                                        id="first_name_edit" placeholder="Vorname">
                                                                    <small id="error_msg_first_name_e"
                                                                        class="form-control-feedback display_none">Vorname
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div id="div_last_name_e" class="form-group ">
                                                                    ...
                                                                    <input onkeyup="error_handle_e('last_name')"
                                                                        type="text" class="form-control"
                                                                        id="last_name_edit" placeholder="Nachname">
                                                                    <small id="error_msg_last_name_e"
                                                                        class="form-control-feedback display_none">Nachname
                                                                        ist erforderlich</small>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_email_e" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_email_e"
                                                                        class="form-control-feedback display_none">E
                                                                        Mail ist erforderlich</small>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_department_e" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_department_e"
                                                                        class="form-control-feedback display_none">Abteilung
                                                                        ist erforderlich</small>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_role_e" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_role_e"
                                                                        class="form-control-feedback display_none">Rolle
                                                                        ist erforderlich</small>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_timeschedule_e" class="form-group ">
                                                                    <select onchange="error_handle_e('time_schedule')"
                                                                        ...
                                                                        <option value="0">Für Zeitplan deaktivieren
                                                                        </option>
                                                                    </select>
                                                                    <small id="error_msg_timeschedule_e"
                                                                        class="form-control-feedback display_none">Der
                                                                        Zeitplanstatus ist erforderlich</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"
                                                    onclick="edituser()">Speichern</button>
                                                <button type="button" class="btn btn-default waves-effect"
                                                    data-dismiss="modal">Abbrechen</button>
                                            </div>
                                        </div>
                                    ...
                                    <table id="demo-foo-addrow"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center bg_app_blue white_color">Vorname</th>
                                                <th class="text-center bg_app_blue white_color">Nachname</th>
                                                <th class="text-center bg_app_blue white_color">Email</th>
                                                <th class="text-center bg_app_blue white_color">Rolle</th>
                                                <th class="bg_app_blue white_color">Status</th>
                                                <?php if ($wage_admin == 1 || $usert_id == 1) { ?>
                                                    <th class="text-center bg_app_blue white_color">Add Wage Data</th>
                                                <?php } ?>
                                                <th class="text-center bg_app_blue white_color">Bearbeiten</th>
                                                <th class="text-center bg_app_blue white_color">
                                                    Löschen</th>
                                            </tr>
                                        </thead>
                                        <tbody>
