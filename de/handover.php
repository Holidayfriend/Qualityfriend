                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_handovers == 1 || $usert_id == 1) { ?>
                            <a href="handover_create.php" class="btn btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Übergabe erstellen</a>
                        <?php } ?>
                    </div>
                                                ...
                                                while ($row = mysqli_fetch_array($result10)) {
                                                    ...
                                                    if ($is_completed == 0) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="label p-2 label-table label-success">Übergaben
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu animated flipInY">
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="delete_handover('<?php echo $row[0]; ?>');">Löschen</a>
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="duplicate_handover('<?php echo $row[0]; ?>');">Duplikat</a>
                                                                            <a class="dropdown-item"
                                                                                href="handover_detail.php?id=<?php echo $row[0]; ?>">Aussicht</a>
                                                                            <a class="dropdown-item"
                                                                                href="handover_edit.php?id=<?php echo $row[0]; ?>">Bearbeiten</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            <?php } ?>
