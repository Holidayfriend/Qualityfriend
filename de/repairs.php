                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_repairs == 1 || $usert_id == 1) { ?>
                            <a href="repair_create.php" class="btn w-100 wm-48 btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Reparatur erstellen</a>
                        <?php } ?>
                    </div>
                                                ...
                                                while ($row = mysqli_fetch_array($result10)) {
                                                    ...
                                                    if ($is_completed == 0) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="label p-2 label-table label-success">Reparatur
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu animated flipInY">
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="delete_repair('<?php echo $row[0]; ?>');">Löschen</a>
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="duplicate_repair('<?php echo $row[0]; ?>');">Duplikat</a>
                                                                            <a class="dropdown-item"
                                                                                href="repair_detail.php?id=<?php echo $row[0]; ?>">Aussicht</a>
                                                                            <a class="dropdown-item"
                                                                                href="repair_edit.php?id=<?php echo $row[0]; ?>">Bearbeiten</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            <?php } ?>
