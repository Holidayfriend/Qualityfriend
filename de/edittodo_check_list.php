            ...
            <div class="container-fluid mobile-container-pl-75">
                ...
                <div class="row page-titles heading_style">
                    <div class="col-md-5 align-self-center">
                        <h5 class="text-themecolor font-weight-title font-size-title mb-0">Aufgaben/Checkliste
                            bearbeiten</h5>
                    </div>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-10 col-xlg-10 col-md-10">
                                                            <input type="text" class="form-control"
                                                                id="add_comments_list_item" placeholder="Text eingeben">
                                                        </div>
                                                        <div class="col-lg-2 col-xlg-2 col-md-2 font-size-title"
                                                            style="text-align: center; display: flex; justify-content: center;align-items: center;">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-default waves-effect"
                                                    data-dismiss="modal">Loschen</button>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
                                ...
                                <div id="add-deepl" class="modal fade in" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog custom_modal_dialog">
                                        <div id="live_tranlator" class="modal-content">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select onchange="deepl_call()" id="deepl_language_id"
                                                                ...
                                                                <option value="PT-PT">Portuguese (all Portuguese
                                                                    varieties)</option>
                                                    ...
                                                    <div class="row pt-2">
                                                        <div class="col-md-6">
                                                            <textarea onkeyup="deepl_call()" type="text" rows="13"
                                                                ...
                                                                placeholder="Schreiben Sie Ihren Text..."></textarea>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <textarea type="text" rows="13" name="output_deepl"
                                                                id="output_deepl" class="form-control"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button onclick="cleared()" type="button"
                                                    class="btn btn-info ">Klar</button>
                                            </div>
                                ...
                                <div class="tab-pane active" id="english" role="tabpanel">
                                    ...
                                    <div class="row pl-2 pr-2 mt-3">
                                        ...
                                        <button type="button" onclick="Language_selected('EN');"
                                            class="btn btn-info ml-3"><i class="fa fa-plus-circle"></i>
                                            Englisch</button>
                                        <button type="button" onclick="Language_selected('IT');"
                                            class="btn btn-info ml-3"><i class="fa fa-plus-circle"></i>
                                            Italienisch</button>
                                    </div>
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-lg-8 col-xlg-8 col-md-8">
                                            <input type="text" ; value="<?php echo $title_de ?>" id="title_id_de"
                                                class="form-control" placeholder="Titel eingeben">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12">
                                            <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                ...
                                                <label class="custom-control-label" for="one_recipient">Ein
                                                    Empfänger</label>
                                            </div>
                                            <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                ...
                                                <label class="custom-control-label" for="all_recipients">Alle
                                                    Empfänger</label>
                                            </div>
                                            <div class="custom-control custom-radio inline-div b-cancle">
                                        ...
                                        <div class="col-lg-9 col-xlg-9 col-md-9">
                                            <div class="custom-control custom-radio inline-div mr-3">
                                                ...
                                                <label class="custom-control-label"
                                                    for="customRadio10">auswählen</label>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-xlg-3 col-md-3">
                                            <div class="input-group">
                                                <input type="text" style="border:1px solid #00BCEB" id="start_date_id"
                                                    class="form-control" placeholder="" value="<?php echo $due_date; ?>">
                                    ...
                                    <?php for ($i = 0; $i < sizeof($attach_id_array); $i++) { ?>
                                        <div id="delete_<?php echo $attach_id_array[$i]; ?>">
                                            <a data-toggle="tooltip"
                                                data-original-title="
                                                                                          Klicken Sie hier, um den Anhang anzuzeigen"
                                                href="<?php echo $attach_url_array[$i]; ?>"
                                                target="_blank"><?php echo 'Anhang-' . ($i + 1); ?></a><a style="color:#f62d51;"
                                                data-toggle="tooltip" data-original-title="Entfernen Attachment"
                                                href="javascript:void(0);" onclick="delete_attachment(<?php echo $attach_id_array[$i];
                                ...
                                <div id="responsive-modal-italian" class="modal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                                        <input type="text" id="title_id_it" class="form-control"
                                                            placeholder="Titel eingeben"
                                                            value="<?php echo $title_it; ?>">
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-success waves-effect"
                                                    onclick="dismiss_modal();" data-dismiss="modal">Hinzufügen</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                                        <input type="text" id="title_id" class="form-control"
                                                            placeholder="Titel eingeben" value="<?php echo $title; ?>">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-10 col-xlg-10 col-md-10">
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12  text-right">
                                        <button data-toggle="modal" data-target="#add-contact" type="button"
                                            class="btn mt-4 btn-secondary"><i
                                                class=" ti-menu-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Checkliste
                                            hinzufügen</button>
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 text-right">
                                        ...
                                        <button onclick="save_todolist('TEMPLATE')" type="button"
                                            class="btn mt-4 btn-warning btn-template">
                                            Als Vorlage speichern</button>
                                        <button onclick="cancel()" type="button"
                                            class="btn mt-4 btn-danger">Abbrechen</button>
                                        <button type="button" onclick="save_todolist('CREATE')"
                                            class="btn mt-4 btn-secondary">Änderungen speichern</button>
                                    </div>
                                </div>
