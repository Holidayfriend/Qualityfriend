            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-12 plm-3 pl-0 mt-1 pr-3">
                        ...
                        ?>
                        <select class="form-control mb-3 " style="background-color:#00BCEB;color:white;" onchange="change_data();" id="modules_list"
                            name="filter_table">
                            <option value="0" disabled>--auswählen--</option>
                            <option value="all" <?php if ($filter_table == 'all')
                                echo 'selected'; ?>>Alle</option>
                            <?php if ($recruiting_flag == 1) { ?>
                                <option value="tbl_applicants_employee" <?php if ($filter_table == 'tbl_applicants_employee')
                                    echo 'selected'; ?>>Recruiting</option>
                            <?php } ?>
                            <?php if ($handover_flag == 1) { ?>
                                <option value="tbl_handover" <?php if ($filter_table == 'tbl_handover')
                                    echo 'selected'; ?>>
                                    Übergaben</option>
                            <?php } ?>
                            <?php if ($handbook_flag == 1) { ?>
                                <option value="tbl_handbook" <?php if ($filter_table == 'tbl_handbook')
                                    echo 'selected'; ?>>
                                    Handbuch</option>
                            <?php } ?>
                            <?php if ($checklist_flag == 1) { ?>
                                <option value="tbl_todolist" <?php if ($filter_table == 'tbl_todolist')
                                    echo 'selected'; ?>>
                                    Todo/Checklist</option>
                            <?php } ?>
                            <?php if ($notices_flag == 1) { ?>
                                <option value="tbl_note" <?php if ($filter_table == 'tbl_note')
                                    echo 'selected'; ?>>Notizen
                                </option>
                            <?php } ?>
                            <?php if ($repairs_flag == 1) { ?>
                                <option value="tbl_repair" <?php if ($filter_table == 'tbl_repair')
                                    echo 'selected'; ?>>
                                    Reparaturen</option>
                            <?php } ?>
                            <?php if ($housekeeping_flag == 1) { ?>
                                <option value="tbl_housekeeping" <?php if ($filter_table == 'tbl_housekeeping')
                                    echo 'selected'; ?>>Housekeeping</option>
                            <?php } ?>
                            <?php if ($time_schedule_flag == 1) { ?>
                                <option value="tbl_shifts" <?php if ($filter_table == 'tbl_shifts')
                                    echo 'selected'; ?>>
                                    Dienstplanung</option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12 pr-0">
                        <button id="del_btn" hidden onclick="delete_all()" type="button"
                            class="btn mt-2 btn-danger mb-3 pl-3 pr-3">Löschen</button>
                    </div>
                </div>
                    ...
                    if ($result && $result->num_rows > 0) {
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"
                                                        class="border mobile_display_none text-center"><b> Autor</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2"
                                                        class="border mobile_display_none  text-center"><b> Beteiligt</b>
                                                    </th>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="5"
                                                        class="border mobile_display_none text-center"><b> Datum</b></th>
                                                </tr>
                                            </thead>
                                                        ...
                                                        <td class="text-center dashboard_action_border">
                                                            <div class="btn-group">
                                                                <span id="thisstatus"
                                                                    ...
                                                                    aria-expanded="false">Aktion</span>

                                                                <div class="dropdown-menu animated flipInY">
                                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                                        onclick="delete_alert('<?php echo $row[0]; ?>')">Löschen</a>
                                                                        ...
                                                                        if ($row['id_table_name'] == "tbl_repair") { ?> <a
                                                                            ...
                                                                            if ($row['id_table_name'] == "tbl_todolist") { ?> <a
                                                                                ...
                                                                                if ($row['id_table_name'] == "tbl_shifts") { ?> <a
                                                                                        class="dropdown-item" href="javascript:void(0);"
                                                                                        onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_shifts','is_completed','<?php if ($status == "Vollendet") {
                                                                                               echo "0";
                                                                                           } else {
                                                                                               echo "1";
                                                                                           } ?>','sfs_id')"><?php if ($status == "Vollendet") {
                                                                                                echo "Erledigt";
                                                                                            } else {
                                                                                                echo "Abgeschlossen markieren";
                                                                                            } ?></a>
                                            ...
                                            <div class="pagination-wrapper">
                                                <ul class="pagination">
                                                    ...
                                                    <li class="page-item <?php if ($page <= 1)
                                                        echo 'disabled'; ?>">
                                                        <a class="page-link"
                                                            href="?page=<?php echo $page - 1; ?>&filter_table=<?php echo $filter_table; ?>">Previous</a>
                                                    </li>
                                                    ...
                                                    if ($start > 1): ?>
                                                        <li class="page-item">
                                                            <a class="page-link"
                                                                href="?page=1&filter_table=<?php echo $filter_table; ?>">1</a>
                                                        </li>
                                                        <?php if ($start > 2): ?>
                                                    ...
                                                    <?php for ($i = $start; $i <= $end; $i++): ?>
                                                        <li class="page-item <?php if ($i == $page)
                                                            echo 'active'; ?>">
                                                            <a class="page-link"
                                                                href="?page=<?php echo $i; ?>&filter_table=<?php echo $filter_table; ?>"><?php echo $i; ?></a>
                                                        </li>
                                                    <?php endfor; ?>
                                                    ...
                                                    <?php if ($end < $totalPages): ?>
                                                        ...
                                                        <li class="page-item">
                                                            <a class="page-link"
                                                                href="?page=<?php echo $totalPages; ?>&filter_table=<?php echo $filter_table; ?>"><?php echo $totalPages; ?></a>
                                                        </li>
                                                    <?php endif; ?>

                                                    <!-- Next Page -->
                                                    <li
                                                        class="page-item <?php if ($page >= $totalPages)
                                                            echo 'disabled'; ?>">
                                                        <a class="page-link"
                                                            href="?page=<?php echo $page + 1; ?>&filter_table=<?php echo $filter_table; ?>">Next</a>
                                                    </li>
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                            <h1 class="text-center pt-5 pb-5 text-success"><i
                                    class="mdi mdi-bell-sleep bell_size text-info"></i> Keine Meldungen gefunden</h1>
                        </div>
                        <?php
                    }
                    ?>
