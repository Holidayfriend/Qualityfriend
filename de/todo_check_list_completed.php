                                        ...
                                        <div class="pagination-wrapper">
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item <?php if ($page <= 1)
                                                    echo 'disabled'; ?>">
                                                   <a class="page-link" href="?page=<?php echo $page - 1; ?>&search=<?php echo $filter_table; ?>&what=<?php echo urlencode($what); ?>">Vorherige</a>
                                                ...
                                                <li class="page-item <?php if ($page >= $totalPages)
                                                    echo 'disabled'; ?>">
                                                   <a class="page-link" href="?page=<?php echo $page + 1; ?>&search=<?php echo $filter_table; ?>&what=<?php echo urlencode($what); ?>">Nächste</a>
