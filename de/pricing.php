...
<body class="skin-default-dark fixed-layout">
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Preise</p>
        </div>
    </div>
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <!-- <h4 class="text-themecolor font-weight-title font-size-title">Preise</h4> -->
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="my_pricing_container">
                            <div class="my_pricing_fade_in">
                                <?php if ($my_plan_status == 'ACTIVE') { ?>
                                    <h3 class="my_pricing_title">Aktiver Plan: <?php echo $my_current_plan; ?></h3>
                                <?php } else {
                                    ?>
                                    <h6 class="red">Ihr Plan ist abgelaufen: <?php echo $my_current_plan; ?></h6>
                                    <?php
                                } ?>
                                <h4 class="my_pricing_title mt-2">Aktualisieren Sie Ihren Plan</h4>
                                            ...
                                            <div class="my_pricing_card_body">
                                                <ul class="my_pricing_feature_list">
                                                    <li class="my_pricing_feature_item"><i
                                                            class="bi bi-check2-circle"></i> Checklisten</li>
                                                    <li class="my_pricing_feature_item"><i
                                                            class="bi bi-arrow-right-circle"></i> Übergaben</li>
                                                    <li class="my_pricing_feature_item"><i class="bi bi-book"></i>
                                                        Handbücher</li>
                                                    <li class="my_pricing_feature_item"><i class="bi bi-tools"></i>
                                                        Reparaturen</li>
                                                    <li class="my_pricing_feature_item"><i
                                                            class="bi bi-calendar-check"></i> Dienstplanung</li>
                                                ...
                                                <a href="#" class="my_pricing_btn_outline_custom"
                                                    style="pointer-events: none; opacity: 0.6;">Kostenloser Plan</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Pro Plan -->
                                            ...
                                            <div class="my_pricing_card_body">
                                                <ul class="my_pricing_feature_list">
                                                    ...
                                                    <li class="my_pricing_feature_item"><strong><i
                                                                class="bi bi-person-plus"></i> Rekrutierungsmodul</strong></li>
                                                </ul>
