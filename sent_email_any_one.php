...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Send Email</p>
        </div>
    </div>
    <!-- ============================================================== -->
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-success">Send Email</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="row pt-4 small-screen-mr-16">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                        ...
                                        <div class="div-background  mt-4 p-4">
                                            ...
                                            <h4 class="font-weight-title">Send To</h4>
                                            <div class="row pl-2 pr-2">
                                            ...
                                            <h4 class="font-weight-title mt-2"><?php //echo  $sql; ?>Subject</h4>
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                        <input type="button" id="" onclick="saveed();"
                                            class="btn mt-4 w-20 btn-secondary" value="send">
