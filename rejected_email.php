...
$my_page_body = '';
$check = "";
$sql1 = "SELECT * FROM `tbl_final_auto_emails` WHERE `hotel_id` =    $hotel_id and `type` = 'rejected' ";
...
<head>
    ...
    <title>Automatic Email Upon Rejection</title>
    <!-- page CSS -->
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Automatic Email Upon Acceptance</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="container-fluid mobile-container-pl-75 ">
                ...
                <div class="row page-titles heading_style">
                    <div class="col-md-5 align-self-center">
                        <h5 class="text-themecolor font-weight-title font-size-title mb-0">Automatic Email Upon
                            Rejection</h5>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-success">Automatic Email Upon Rejection</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                        <div class="row pl-2 pr-2">
                                            <select id="template" class="select2 form-control custom-select">
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM `email_template` where `template_type` = 'rejected'";
                                        ...
                                        <div class="div-background  mt-4 p-4">
                                            <h6 class="red">
                                                Use <strong>{{name}}</strong> to insert the applicant’s name,
                                                <strong>{{logo}}</strong> for your hotel’s logo,
                                                <strong>{{hotel_name}}</strong> to display the hotel’s name,
                                                <strong>{{job_name}}</strong> for the job title, and
                                                <strong>{{hotel_email}}</strong> for the hotel’s contact email.
                                            </h6>
                                            <div class="form-check form-switch mt-4 p-4">
                                                <input <?php echo $check; ?> class="form-check-input" type="checkbox"
                                                    id="is_auto_on">
                                                <label class="form-check-label" for="is_auto_on">On Auto Email</label>
                                            </div>
                                            <h4 class="font-weight-title">Subject</h4>
                                            ...
                                            <div class="row pt-4 ">
                                                <div class="col-lg-12 wm-70 col-xlg-12 col-md-12">
                                                    <h4 class="font-weight-title ">Body</h4>
                                                </div>
