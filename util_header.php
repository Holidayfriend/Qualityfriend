                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu mailbox animated bounceInDown" id="result_notifications">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="nav-link text-center m-b-5" href="dashboard.php"> <strong>Check all
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox animated bounceInDown" aria-labelledby="2" id="result_msg">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center link m-b-5" href="chat.php"> <b>See all messages</b> <i
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY"
                        ...
                        <a class="dropdown-item" href="user_profile.php"><i class="ti-user m-r-5 m-l-5"></i> My
                            Profile</a>
                        <a class="dropdown-item" href="pricing.php"><i class="mdi mdi-verified m-r-5 m-l-5"></i>Update
                            Softwere</a>
                        <?php if ($Send_Receive_messages == 1 || $usert_id == 1) {
                            if ($chat_flag == 1) {
                                ?>
