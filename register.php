    ...
    <div class="register-container">
        ...
        <div class="right-section">
            <form id="registerForm">
                ...
                <div class="form-group">
                    <input type="text" id="hotel_name" class="form-control" placeholder="Hotel Name">
                </div>
                ...
                <div class="form-group">
                    <input type="tel" id="phone_number" class="form-control" placeholder="Phone Number (Optional)">
                </div>
                ...
                <div class="form-group">
                    <input type="text" id="street_address" class="form-control" placeholder="Street and Number">
                </div>

                <div class="form-group">
                    <input type="text" id="postal_code" class="form-control" placeholder="ZIP / Postal Code">
                </div>
                ...
                <div class="form-group">
                    <div class="checkbox-container">
                        ...
                        <label for="terms">
                            I accept the <a href="https://www.holidayfriend.solutions/en/terms" target="_blank">Terms of
                                Service</a> and <a href="https://www.holidayfriend.solutions/en/privacy"
                ...
                <div class="text-center mt-4">
                    <button type="button" id="registerBtn" class="btn register-btn text-white">Register</button>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#registerBtn').click(function () {
                ...
                if (!terms) {
                    $('#terms-error').text('You must accept the Terms of Service and Privacy Policy');
                    isValid = false;
                }
                if (!logo_file) {
                ...
                if (isValid) {
                    ...
                    formData.append('hotel_language', 'EN');
