...
<div class="modal-header">
    <h4 class="modal-title m-2" id="teamModalLabel">Rules</h4>
...
function getRuleDescription($ruleKey)
{
    ...
    $rules = [
        'rule_1' => 'Create and edit todo/checklist',
        'rule_2' => 'Create and edit handbooks',
        'rule_3' => 'Create and edit repairs',
        'rule_4' => 'Create and edit notices',
        'rule_5' => 'Create and edit handovers',
        'rule_6' => 'Edit users, teams and departments',
        'rule_7' => 'Send and receive messages',
        'rule_8' => 'Edit roles',
        'rule_12' => 'Manage Time Schedules',
        'rule_15' => 'Wage Admin',
        'rule_16' => 'Forecasting Admin',
        'rule_13' => 'Housekeeper',
        'rule_14' => 'Housekeeping Admin',
        'rule_9' => 'Create and edit job-ad',
        'rule_10' => 'Create, view and edit applications',
        'rule_11' => 'Create, view and edit employees',
        'rule_17' => 'Create and edit working time',
    ];
