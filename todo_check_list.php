                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_todo_checklist == 1 || $usert_id == 1) { ?>
                            <a href="create_todo_checklist.php" class="btn btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Create Todo/Checklist</a>
                        <?php } ?>
                    </div>
                    <?php
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu animated flipInY">
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="todo_check_list_detail.php?id=<?php echo $row['tdl_id']; ?>">View</a>

                                                                            <a class="dropdown-item"
                                                                                href="edittodo_check_list.php?id=<?php echo $row['tdl_id']; ?>">Edit</a>
