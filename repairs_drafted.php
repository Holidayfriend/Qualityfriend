        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid mobile-container-padding">
                ...
                <div class="row page-titles heading_style">
                    ...
                    $sqlCount = "SELECT COUNT(*) AS total FROM`tbl_repair` WHERE `hotel_id` = $hotel_id and is_delete = 0 and saved_status = 'DRAFT'";
                    ...
                    $sql .= " ORDER BY `tbl_repair`.`rpr_id` DESC LIMIT $offset, $recordsPerPage";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr id="<?php echo $i; ?>">
                                                        ...
                                                        <td class="font-size-subheading text-center"><a
                                                                href="repair_edit.php?id=<?php echo $row['rpr_id']; ?>"><i
