                                ...
                                <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                    <li class="nav-item w-180-custom wm-50px"> <a class="nav-link active"
                                            data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i
                                                    class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Worked
                                                Hours</span> </a> </li>
                                ...
                                <div class="tab-content w-100">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <select id="1_select1" class="form-control custom-select">
                                                            <option value="0" disabled selected>Select an Employee
                                                            </option>
                                                            <?php
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 mt-3">
                                                        <input type="button" onclick="get_report_workedHours();"
                                                            class="btn mt-4 w-100 btn-info" value="Get Report">
                                                    </div>
                                        ...
                                        <div class="row pl-1">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="button" onclick="get_report_emp_timesheet();"
                                                    class="btn mt-5 w-30 btn-info" value="Get Report">
                                    ...
                                    <div class="tab-pane" id="messages13" role="tabpanel">
                                        <div class="row pl-1">
                                            <div class="col-lg-4">
                                                <h3>Time Off</h3>
                                                <span>A detailed view of approved days off per employee including who
                                                    approved the request</span>
                                                <br>
                                                <label class="control-label mt-4"><strong>Date range</strong></label>
                                                <div class="input-group">
                                                    <input class="form-control input-daterange-datepicker" type="text"
                                    ...
                                    <div class="tab-pane" id="messages3" role="tabpanel">
                                        <div class="row pl-1">
                                            <div class="col-lg-4">
                                                ...
                                                <label class="control-label mt-3"><strong>Shift Offered By
                                                        Employee</strong></label>
                                                <select id="4_select1" class="form-control custom-select">
                                                    <?php
                                                    if ($wage_admin == 1 || $usert_id == 1) {
                                                        $sql = "SELECT * FROM `tbl_user` WHERE `hotel_id` = $hotel_id and is_delete = 0 and is_active = 1";
                                                        echo '<option value="0">Select an Employee</option>';
                                                    } else {
                                                        $sql = "SELECT * FROM `tbl_user` WHERE `hotel_id` = $hotel_id and is_delete = 0 and is_active = 1 and user_id = $user_id";
                                                        echo '<option value="0" disabled selected>Select an Employee</option>';
                                                    }
                                                ...
                                                <label class="control-label mt-3"><strong>Shift Offered To
                                                        Employee</strong></label>
