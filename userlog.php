        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mb-0 mobile-container-padding">
                    ...
                    ?>
                    <?php if ($usert_id == 1) { ?>
                        <div class="col-lg-2 col-md-2 align-self-center mtm-5px">
                            <div class="list-background-second">
                                <select class=" form-control " onchange="change_data();"
                                    ...
                                    <option <?php if ($filter_table == $user_id)
                                        echo 'selected'; ?>
                                        value="<?php echo $user_id; ?>">Personal Log</option>
                                    <?php
                            ...
                            <div class="card">
                                <div class="card-body pm-0 pt-0 small-screen-pr-0 mobile-container-pl-60">
                                    <div class="table-responsive">
                                        <table 
                                            class="inline-table tablesaw table-bordered table-hover table no-wrap"
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    <th scope="col" data-tablesaw-sortable-col
                                                        data-tablesaw-priority="persist" class="border text-center"><b>Log
                                                            Title &amp; Type</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"
                                                        class="border text-center"><b> User</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2"
                                                        class="border text-center"><b> Date &amp; Time</b></th>
                                                </tr>
                                            </thead>
