...
<head>
    ...
    <title>Created Checklists</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    ...
                    <div class="col-md-3 align-self-center">
                        <h4 class="text-themecolor font-weight-title font-size-title">Created Checklists</h4>
                    </div>
                    ...
                    <div class="col-md-3 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-success">Created Checklists</li>
                            </ol>
                        </div>
                    </div>
                </div>
