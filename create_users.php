                        ...
                        <div class="card">
                            <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-12 wm-0">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-12 wm-28  mt-3 mb-3 mt-md-0 mb-md-0">
                                        ...
                                        <!-- <button type="button"
                                            class="btn btn-secondary mtm-0 m-t-5 mb-2 float-right green_background_color"
                                            data-toggle="modal" data-target="#add-contact">Add User</button> -->
                                    </div>
                                </div>
                                                            ...
                                                            <div class="col-md-12 m-b-20 mt-2">
                                                                <div id="div_first_name_e" class="form-group ">
                                                                    <input onkeyup="error_handle_e('first_name')"
                                                                        ...
                                                                        id="first_name_edit" placeholder="First Name">
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div id="div_last_name_e" class="form-group ">
                                                                    <input onkeyup="error_handle_e('last_name')"
                                                                        type="text" class="form-control"
                                                                        id="last_name_edit" placeholder="Last Name">
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_timeschedule_e" class="form-group ">
                                                                    <select onchange="error_handle_e('time_schedule')"
                                                                        ...
                                                                        <option value="1">Active For Time Schedule
                                                                        </option>
                                                                        <option value="0">Deactive For Time Schedule
                                                                        </option>
                                                                    </select>
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-addrow"
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="text-center bg_app_blue white_color">No</th>
                                                <th class="text-center bg_app_blue white_color">First Name</th>
                                                <th class="text-center bg_app_blue white_color">Last Name</th>
                                                <th class="text-center bg_app_blue white_color">Email</th>
                                                <th class="text-center bg_app_blue white_color">Role</th>
                                                <th class="text-center bg_app_blue white_color">Status</th>
                                                <?php if ($wage_admin == 1 || $usert_id == 1) { ?>
                                                    <th class="text-center bg_app_blue white_color">Add Wage Data</th>
                                                <?php } ?>
                                                <th class="text-center bg_app_blue white_color">Edit</th>
                                                <th class="text-center bg_app_blue white_color">Delete</th>
                                            </tr>
                                        </thead>
                                        <tbody>
