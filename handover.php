                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_handovers == 1 || $usert_id == 1) { ?>
                            <a href="handover_create.php" class="btn btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Create Handover</a>
                        <?php } ?>
                    </div>
                    <?php
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu animated flipInY">
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="delete_handover('<?php echo $row[0]; ?>');">Delete</a>
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="duplicate_handover('<?php echo $row[0]; ?>');">Duplicate</a>
                                                                            <a class="dropdown-item"
                                                                                href="handover_detail.php?id=<?php echo $row[0]; ?>">View</a>
                                                                            <a class="dropdown-item"
                                                                                href="handover_edit.php?id=<?php echo $row[0]; ?>">Edit</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            <?php } ?>
