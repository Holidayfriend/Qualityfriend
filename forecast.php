            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left black_color">Staffing Departments</h3>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group" id="delete_shift_date_form">
                                <label for="message-text" class="control-label ml-1 black_color"><b>Staff Department
                                        Title</b></label>
                            ...
                            <div class="form-group">
                                <div class="p-2 h-400px" id="reload_departments">
                                    <div class="form-group mb-0 black_color">
                                        <label class="control-label display-inline w-80 wm-50 black_color"><strong>Staff
                                                Department
                                                Title</strong></label>
                                        <label
                                            class="control-label display-inline w-18 wm-50 black_color"><strong>Action</strong></label>
                                    </div>
                                    <?php
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect"
                            onclick="dismiss_modal_delete_department();" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    <div class="col-md-3 align-self-center">
                        <h4 class="text-themecolor font-weight-title font-size-title">Budget &amp; Forecast
                            (<?php echo $year_; ?>)</h4>
                    </div>
                    <div class="col-md-6 text-center">
                        <button type="button" onclick="show_important_things();" class="btn btn-dark">Short
                            Report</button>
                    </div>
                            ...
                            <div class="card-body p-0 pt-1">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" id="profile-tab1" data-toggle="tab"
                                            href="#profile1" role="tab" aria-controls="profile"><span>Yearly
                                                Forecast</span></a></li>
                                    <li class="nav-item"> <a class="nav-link" id="profile-tab2" data-toggle="tab"
                                            href="#profile2" role="tab" aria-controls="profile"><span>Budget
                                                Effective</span></a></li>
                                    <li class="nav-item"> <a class="nav-link" id="profile-tab3" data-toggle="tab"
                                            href="#profile3" role="tab" aria-controls="profile"><span>Budget
                                                Forecast</span></a></li>
                                    <li class="nav-item"> <a class="nav-link" id="profile-tab4" data-toggle="tab"
                                            href="#profile4" role="tab" aria-controls="profile"><span>Working</span></a>
                                    </li>
                                    <li class="nav-item"> <a class="nav-link" id="profile-tab5" data-toggle="tab"
                                            href="#profile5" role="tab"
                                            aria-controls="profile"><span>Staffing</span></a></li>
                                    <li class="nav-item"> <a class="nav-link" id="profile-tab6" data-toggle="tab"
                                            href="#profile6" role="tab" aria-controls="profile"><span>Goods
                                                Purchasings</span></a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" id="dropdown1-tab" href="#dropdown1" role="tab"
                                                data-toggle="tab" aria-controls="dropdown1">Revenues</a>
                                            <a class="dropdown-item" id="dropdown2-tab" href="#dropdown2" role="tab"
                                                data-toggle="tab" aria-controls="dropdown2">Expenses</a>
                                            <a class="dropdown-item" id="dropdown3-tab" href="#dropdown3" role="tab"
                                                data-toggle="tab" aria-controls="dropdown3">Key Facts</a>
                                            <a class="dropdown-item" id="dropdown4-tab" href="#dropdown4" role="tab"
                                                data-toggle="tab" aria-controls="dropdown4">Staffing</a>
                                            <a class="dropdown-item" id="dropdown5-tab" href="#dropdown5" role="tab"
                                                data-toggle="tab" aria-controls="dropdown5">Goods Purchasings</a>
                                        </div>
                                    </li>
                                </ul>
                                <div class="tab-content tabcontent-border p-20 pl-0 pr-0" id="myTabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php } else { ?>
                                                <div class="col-lg-12 text-center">
                                                    <div class="text-center"><img src="assets/images/no-results-cookie.png"
                                                            width="250" /></div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left" colspan="14">
                                                                        <b><?php echo 'Operating Revenue'; ?></b>
                                                                    </td>
                                                                </tr>

                                                                <tr class="">
                                                                    <td class="text-left">
                                                                        <?php echo 'Hotel Revenues Net'; ?>
                                                                    </td>
                                                                ...
                                                                <tr class="">
                                                                    <td class="text-left">
                                                                        <?php echo 'Ancillary Revenues Net'; ?>
                                                                    </td>
                                                                ...
                                                                <tr class="">
                                                                    <td class="text-left"><?php echo 'Spa Revenues Net'; ?>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left" colspan="14"><?php echo 'Cost'; ?>
                                                                    </td>
                                                                </tr>
                                                                <tr class="">
                                                                    <td class="text-left">
                                                                        <?php echo 'Costs Of Goods Halfboard'; ?>
                                                                    </td>
                                                                ...
                                                                <tr class="">
                                                                    <td class="text-left">
                                                                        <?php echo 'Costs Of Ancillary Goods'; ?>
                                                                    </td>
                                                                ...
                                                                <tr class="">
                                                                    <td class="text-left">
                                                                        <?php echo 'Costs Of Spa Products'; ?>
                                                                    </td>
                                    ...
                                    <div class="tab-pane fade" id="profile3" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3 class="forecast_main_color p-3 text-center font_size_forecast_1rem">
                                                    Budget Preview (Forecast) <button class="float-right" id="btnExport"
                                                        onclick="export_forecast(this)">Export</button></h3>
                                            </div>
                                                    ...
                                                    <div class="table-responsive text-center">
                                                        <table class="table mobile_response_forecast_tables">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="">
                                                                    <td class="text-left">
                                                                        <?php echo 'Occupancy rate in %'; ?> <span
                                                                ...
                                                                <tr class="forecast_light_gray_color">
                                                                    <td class="text-left"><?php echo 'Total'; ?> <span
                                                                            class="float-right">&nbsp;%</span><span
                                                                ...
                                                                <tr class="forecast_light_gray_color">
                                                                    <td class="text-left"><?php echo 'Total Costs'; ?> <span
                                                                            class="float-right">&nbsp;%</span><span
                                                                            class="float-right wm-23 w-47"><input
                                                                                type="number" min="0"
                                                                                class="form-control display-inline"
                                            ...
                                            <?php } else { ?>
                                                <div class="col-lg-12 text-center">
                                                    <div class="text-center"><img src="assets/images/no-results-cookie.png"
                                                            width="250" /></div>
                                                    <h5 class="text-center"><b>Minimum previous 15 months record required
                                                            please add first.</b></h5>
                                                </div>
                                            <?php } ?>
                                        ...
                                        <div class="table-responsive text-center">
                                            <table class="table mobile_response_forecast_tables">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        <td class="text-left"><?php echo 'Ancillary Revenues Net'; ?>
                                                        </td>
                                                        <td><?php echo number_format(round(array_sum($anicillary_sale_arr2), 2), 1, ',', '.'); ?>
                                                        </td>
                                    ...
                                    <div class="tab-pane fade" id="profile1" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3 class="forecast_main_color p-3 text-center font_size_forecast_1rem">
                                                    Yearly Budget forecast and effective <button class="float-right"
                                                ...
                                                <div class="table-responsive">
                                                    <table id="scroll_bar_table"
                                                        ...
                                                        <tbody class="text-center">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">Ancillary revenues (drinks, etc.)
                                                                </td>
                                                                <?php
                                                                for ($i = 0; $i < 12; $i++) {
                                                                    if (isset($anicillary_sale_arr2[$i])) {
                                                            ...
                                                            <tr>
                                                                <td class="text-left"><small>… Per overnight
                                                                        stay</small></td>
                                                                <?php
                                                                for ($i = 0; $i < 12; $i++) {
                                                                    if (isset($spa_sale_arr2[$i])) {
                                                            ...
                                                            <tr>
                                                                <td class="text-left text-bold">Total Hotel Revenue net
                                                                </td>
                                                                <td colspan="25"></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="text-left text-bold">Earnings before Taxes
                                                                </td>
                                                                <td colspan="25"></td>
                                                            </tr>
                                                            <tr class="forecast_pink_color">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3 class="forecast_main_color p-3 font_size_forecast_1rem">BUDGET
                                                    PREVIEW [FORECAST VS EFFECTIVE] <button id="btnExport"
                                                        class="float-right"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="table-responsive text-center">
                                                    <table class="table" id="table">
                                                                ...
                                                                <th class="" colspan="2">
                                                                    <div class="btn-group" role="group"
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            class="btn btn-info">Current Year
                                                                            Forecast</button>
                                                                        <button type="button"
                                                                            onclick="redirect_url('forecast.php?slug=<?php echo date('Y', strtotime('+1 year')); ?>');"
                                                                            class="border-left-split-buttons btn btn-info">Next
                                                                            Year Forecast</button>
                                                                    </div>
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            <tr class="forecast_main_color">
                                                                <td class="text-left"><?php echo 'Operating Revenue'; ?>
                                                                </td>
                                                                <td><?php if (isset($spa_sale_arr2[0])) {
                                            ...
                                            <div class="col-lg-9 col-sm-9 margin_is">

                                                <div class="table-responsive text-center">
                                                    <table class="table goods_table_responsive">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-left" colspan="14">Budget
                                                                    Overview</th>
                                                            </tr>
                                                            <tr class="forecast_main_color">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="">
                                                                <td class="text-left">
                                                                    <?php echo 'Total BankKonto Forecast'; ?>
                                                                </td>
                                                            ...
                                                            <tr class="">
                                                                <td class="text-left">
                                                                    <?php echo 'Total BankKonto Effective'; ?>
                                                                </td>
                                                ...
                                                <div class="row mt-5">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <h4 class="card-title mtm_30">Betriebserlöse Forecast vs
                                                            Effective</h4>
                                                        <div id="main" class="height_size_forecast_450px"
                                                            style="width:100%; height:300px;"></div>

                                                        <h4 class="card-title mtm_30">Betriebsaufwände Forecast vs
                                                            Effective</h4>
                                                        <div id="main2" class="height_size_forecast_450px"
                                                            style="width:100%; height:300px;"></div>

                                                        <h4 class="card-title mtm_30">Bruttobetriebsgewinn Forecast vs
                                                            Effective</h4>
                                    ...
                                    <div class="tab-pane fade" id="profile6" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3 class="forecast_main_color p-3 text-center">GOODS PURCHASING FOR THE
                                                    KITCHEN
                                                    <button class="float-right" id="btnExport"
                                                    ...
                                                    <div class="table-responsive goods_table_responsive">
                                                        <table class="pb-3 table table table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="forecast_main_color">
                                                                    <td class="text-bold">
                                                                        <?php echo 'Total WES per person/year'; ?>
                                                                    </td>
                                                                    <td class="text-bold">
                                    ...
                                    <div class="tab-pane fade" id="dropdown1" role="tabpanel"
                                        ...
                                        <div class="row mtm-0">
                                            <div class="col-lg-4 right-border-div pr-5 prm-0px">
                                                ...
                                                <div class="mt-4">
                                                    <h3><span id="add_or_edit_revenues_text">Add</span> Revenues <button
                                                            onclick="clear_revenues_values();" type="button"
                                                            class="btn btn-primary float-right">Clear Values</button>
                                                    </h3>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-0">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Hotel
                                                                    Revenues Net</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Ancillary
                                                                    Revenues Net</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Spa
                                                                    Revenues Net (22%)</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Other
                                                                    Revenues Net</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input step="any" type="number"
                                                        ...
                                                        <div class="form-group mb-0 mt-3 mrm-12px">
                                                            <label
                                                                class="control-label display-inline w-100 wm-100"><strong>Account
                                                                    Balance (Jan Only)</strong></label>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Month</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Year</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                ...
                                                <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0 mrm-12px">
                                                    <input type="button" onclick="save_revenue();"
                                                        class="btn mt-4 w-100 btn-primary" value="Save Revenue">
                                                </div>
                                            ...
                                            <div class="col-lg-8 pl-5 plm-10px" id="reload_revenues">
                                                ...
                                                <?php } else { ?>
                                                    <div class="text-center mt-5 pt-4"><img
                                                            src="assets/images/no-results-cookie.png" width="250" /></div>
                                    ...
                                    <div class="tab-pane fade" id="dropdown2" role="tabpanel"
                                        ...
                                        <div class="row mtm-0">
                                            <div class="col-lg-4 right-border-div pr-5 prm-0px">
                                                ...
                                                <div class="mt-4">
                                                    <h3><span id="add_or_edit_expenses_text">Add</span> Expenses <button
                                                            onclick="clear_expenses_values();" type="button"
                                                            class="btn btn-success float-right">Clear Values</button>
                                                    </h3>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Ancillary
                                                                    Goods Cost</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Spa
                                                                    Products Cost</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input step="any" type="number"
                                                                class="form-control display-inline w-47 wm-47"
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Total
                                                                    Operating Cost</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Administration
                                                                    Cost</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input step="any" type="number"
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            ...
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Taxes</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input step="any" type="number"
                                                                class="form-control display-inline w-47 wm-47"
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Bank
                                                                    Charges</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Total
                                                                    Loan (Jan Only)</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input type="number" step="any"
                                                                class="form-control display-inline w-47 wm-47"
                                                        ...
                                                        <div class="form-group mb-0 mt-3 mrm-12px">
                                                            <label
                                                                class="control-label display-inline w-100 wm-100"><strong>Other
                                                                    Costs</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0 mrm-12px">
                                                            <input type="number" step="any"
                                                ...
                                                <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0 mrm-12px">
                                                    <input type="button" onclick="save_cost();"
                                                        class="btn mt-4 w-100 btn-success" value="Save Expense">
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="dropdown3" role="tabpanel"
                                        ...
                                        <div class="row mtm-0">
                                            <div class="col-lg-4 right-border-div pr-5 prm-0px">
                                                ...
                                                <div class="mt-4">
                                                    <h3><span id="add_or_edit_key_text">Add</span> Key Facts <button
                                                            onclick="clear_key_values();" type="button"
                                                            class="btn btn-info float-right">Clear Values</button></h3>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Rooms</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Beds</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input type="number"
                                                                class="form-control display-inline w-47 wm-47"
                                                        ...
                                                        <div class="form-group mb-0 mt-3 mrm-12px">
                                                            <label
                                                                class="control-label display-inline w-100 wm-100"><strong>Opening
                                                                    Days</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0 mrm-12px">
                                                            <input type="number"
                                                ...
                                                <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0 mrm-12px">
                                                    <input type="button" onclick="save_facts();"
                                                        class="btn mt-4 w-100 btn-info" value="Save Key Facts">
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="dropdown4" role="tabpanel"
                                        ...
                                        <div class="row mtm-0">
                                            <div class="col-lg-4 right-border-div pr-5 prm-0px">
                                                ...
                                                <div class="mt-4">
                                                    <h3><span id="add_or_edit_staffing_text">Add</span> Staffing Cost
                                                        <button onclick="clear_staffing_values();" type="button"
                                                            class="btn btn-warning float-right">Clear Values</button>
                                                    </h3>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group mb-0 mrm-12px">
                                                            <label
                                                                class="control-label display-inline w-100 wm-100"><strong>Staff
                                                                    Name</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0 mrm-12px">
                                                            <input type="text"
                                                                class="form-control display-inline w-100 wm-100"
                                                                id="staff_name"
                                                                placeholder="e.g. Reception 1, Operation Mgr, Kitchen 1...">
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            ...
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>End</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input type="date"
                                                                class="form-control display-inline w-47 wm-47"
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            <label
                                                                class="control-label display-inline w-47 wm-47"><strong>Gross
                                                                    Salary/Month (€)</strong></label>
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Net
                                                                    Salary/Month (€)</strong></label>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                            <input type="number" step="any"
                                                        ...
                                                        <div class="form-group mb-0 mt-3">
                                                            <label
                                                                class="control-label display-inline ml-2 w-47 wm-47"><strong>Staffing
                                                ...
                                                <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0 mrm-12px">
                                                    <input type="button" onclick="save_staff_cost();"
                                                        class="btn mt-4 w-100 btn-warning" value="Save Staff Cost">
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="dropdown5" role="tabpanel"
                                        ...
                                        <div class="row mtm-0">
                                            <div class="col-lg-4 right-border-div pr-3 prm-0px">
                                                ...
                                                <div class="mt-4">
                                                    <h3><span id="add_or_edit_goods_text">Add</span> Suppliers Cost
                                                        <button onclick="clear_goods_values();" type="button"
                                                            class="btn btn-dark float-right">Clear Values</button>
                                                    </h3>
                                                </div>
                                                ...
                                                <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0 mrm-12px">
                                                    <input type="button" onclick="save_goods_cost();"
                                                        class="btn mt-4 w-100 btn-dark" value="Save Suppliers">
                                                </div>
    ...
    <script>
        ...
        function save_staff_cost() {
            ...
            if (start_staffing > end_staffing || start_staffing == "" || end_staffing == "" || (date1.getMonth() != date2.getMonth() && staffings_id != 0) || department_staffing == 0) {
                if (staffings_id != 0) {
                    alert("Department is required/Enter Correct Dates/Select Same month for update.");
                } else {
                    alert("Department is required/Enter Correct Dates.");
