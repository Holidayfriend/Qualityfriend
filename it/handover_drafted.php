        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    ...
                    $sqlCount = "SELECT COUNT(*) AS total FROM `tbl_handover` WHERE `hotel_id` = $hotel_id and is_delete = 0 and saved_status = 'DRAFT'";
                    ...
                    $sql .= " ORDER BY `tbl_handover`.`hdo_id` DESC LIMIT $offset, $recordsPerPage";
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr id="<?php echo $i; ?>">
                                                        ...
                                                        <td class="mobile_display_none"><?php echo $row['visibility_status']; ?>
                                                        </td>
                                                        <td class="font-size-subheading text-center"><a
                                                                href="handover_edit.php?id=<?php echo $row['hdo_id']; ?>"><i
