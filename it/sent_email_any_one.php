...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Invia email</p>
        </div>
    </div>
    <!-- ============================================================== -->
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-success">Invia email</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="row pt-4 small-screen-mr-16">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                        ...
                                        <div class="div-background  mt-4 p-4">
                                            <h6 class="red">
                                                Usa <strong>{{name}}</strong> per inserire il nome del candidato,
                                                <strong>{{logo}}</strong> per il logo del tuo hotel,
                                                <strong>{{hotel_name}}</strong> per mostrare il nome dell’hotel,
                                                <strong>{{job_name}}</strong> per il titolo del lavoro e
                                                <strong>{{hotel_email}}</strong> per l’email di contatto dell’hotel.
                                            </h6>

                                            <h4 class="font-weight-title"> Invia a</h4>
                                            <div class="row pl-2 pr-2">
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                        <input type="button" id="" onclick="saveed();"
                                            class="btn mt-4 w-20 btn-secondary" value="Invia">
                                        <input type="button" id="" onclick="cancel();"
                                            class="btn mt-4 w-20 ml-3 wm-30  btn-outline-info" value="Annulla">
