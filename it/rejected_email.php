...
<head>
    ...
    <title>E-mail automatica in caso di rifiuto</title>
    <!-- page CSS -->
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">E-mail automatica in caso di rifiuto</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="container-fluid mobile-container-pl-75 ">
                ...
                <div class="row page-titles heading_style">
                    <div class="col-md-5 align-self-center">
                        <h5 class="text-themecolor font-weight-title font-size-title mb-0">Email automatica su
                        Rifiuto</h5>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-success">E-mail automatica in caso di rifiuto</li>
                            </ol>
                        </div>
                    </div>
