...
<head>
    ...
    <title>Tutto: modello di posta elettronica </title>
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Tutto: modello di posta elettronica</p>
        </div>
    </div>
    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="mobile-container-padding">
                    ...
                    if ($filter_table !== '') {
                        $sql .= "  WHERE (`template_type` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `template_name_it` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `subject_it`  LIKE '%" . $conn->real_escape_string($filter_table) . "%')";
                    }
                    ...
                    if ($filter_table !== '') {
                        $sqlCount .= " WHERE (`template_type` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `template_name_it` LIKE '%" . $conn->real_escape_string($filter_table) . "%' OR `subject_it`  LIKE '%" . $conn->real_escape_string($filter_table) . "%')";
                    }
                    ...
                    <div class="mobile-container-padding">
                        <div class="row page-titles mb-3 heading_style">
                            <div class="col-md-3 align-self-center">
                                <h5 class="text-themecolor font-weight-title font-size-title mb-0">Tutto: modello di
                                    posta elettronica
                                </h5>
                            </div>
                            ...
                            <div class="col-md-3 align-self-center text-right">
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Automazione della posta
                                                elettronica</a>
                                        </li>
                                        <li class="breadcrumb-item text-success">Tutto: modelli di posta elettronica
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12  col-md-12 mt-2 mb-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Il mio sottodominio <small></small></h4>
                                <input value="<?php echo $sub_domain; ?>" type="text" id="sub_domain"
                                    class="form-control" placeholder="Sub Domain">

                                <h4 class="card-title mt-2">Email di Risposta<small></small></h4>
                                <input value="<?php echo $reply_mail; ?>" type="text" id="reply_mail"
                                    class="form-control" placeholder="Email di Risposta">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                <h4 class="card-title inline-div mtm-10 mbm-0">Modelli</h4>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr id="<?php echo $i; ?>">
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['template_name_it']; ?></td>
                                                        <td><?php echo $row['template_type']; ?></td>
                                                        <td><?php echo $row['subject_it']; ?></td>
                                                        <td><?php echo $row['body_it']; ?></td>
                                        ...
                                        <div class="pagination-wrapper">
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item <?php if ($page >= $totalPages)
                                                    echo 'disabled'; ?>">
                                                    <a class="page-link"
                                                        href="?page=<?php echo $page + 1; ?>&search=<?php echo $filter_table; ?>">Prossimo</a>
                                                </li>
    ...
    <script>
        ...
        function save() {
            ...
            if (!sub_domain) {
                Swal.fire({
                    title: 'Il sottodominio è obbligatorio',
                    icon: 'warning',
