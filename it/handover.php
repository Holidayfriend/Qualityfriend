        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    ...
                    $baseConditions = "`is_delete` = 0 AND `hotel_id` = $hotel_id AND status_id = 6 AND saved_status = 'CREATE'";
                    $filterConditions = '';
                    ...
                    if ($Create_edit_handovers == 1 || $usert_id == 1) {
                        ...
                        $sql = "SELECT `hdo_id`, `title`, `title_it`, `title_de`,
    `tags`, `visibility_status`, `saved_status`, `hotel_id`, `is_active`, `is_delete`, `entrytime`,
    `entrybyid`, `entrybyip`, `lastedittime`, `lasteditbyid`, `lasteditbyip`, `status_id`
    FROM `tbl_handover` WHERE $baseConditions $filterConditions";
                        $sqlCount = "SELECT COUNT(*) AS total FROM `tbl_handover` WHERE $baseConditions $filterConditions";
                    } else {
                        // SQL for users with restricted access
                        $sql = "
        SELECT DISTINCT a.`hdo_id`, a.`title`, a.`title_it`, a.`title_de`,
    a.`tags`, a.`visibility_status`, a.`saved_status`, a.`hotel_id`,a.`is_active`, a.`is_delete`, a.`entrytime`,
    a.`entrybyid`, a.`entrybyip`, a.`lastedittime`, a.`lasteditbyid`, a.`lasteditbyip`, a.`status_id`
        FROM `tbl_handover` AS a
        LEFT JOIN `tbl_handover_recipents` AS b ON a.hdo_id = b.hdo_id
        LEFT JOIN `tbl_handover_departments` AS c ON a.hdo_id = c.hdo_id
        WHERE a.$baseConditions
          AND a.is_active = 1
          AND (a.visibility_status = 'PUBLIC' OR b.user_id = $user_id OR c.depart_id = $depart_id)
          $filterConditions";
                ...
                <div class="row pl-3 pr-3">
                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_handovers == 1 || $usert_id == 1) { ?>
                            <a href="handover_create.php" class="btn btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Creare Handovers</a>
                        <?php } ?>
                    </div>
                                        ...
                                        <table id="myTable" class=" tablesaw table-bordered table-hover table no-wrap"
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result10)) {
                                                    ...
                                                    $sql_sub = "select firstname from tbl_user where user_id = $row[14]";
                                                        ...
                                                        <tr>
                                                            <td class="text-center"><b><?php echo $title; ?></b><br>
                                                                <div class="label pl-4 pr-4 label-table btn-info cursor-pointer"
                                                                    onclick="redirect_url('handover_detail.php?id=<?php echo $row[0]; ?>');">
                                                                    Handovers</div>
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($result_sub1 && $result_sub1->num_rows > 0) {
                                                                    ...
                                                                    <div class="label p-2 m-1 label-table label-inverse">
                                                                        <?php echo $row_sub1['department_name']; ?></div>
                                                                    <?php
                                                                }
                                                                if ($result_sub2 && $result_sub2->num_rows > 0) {
                                                                    while ($row_sub2 = mysqli_fetch_array($result_sub2)) {
                                                                        ?>
                                                                        <div class="label p-2 m-1 label-table label-inverse">
                                                                            <?php echo $row_sub2['firstname']; ?></div>
                                                                    <?php }
                                                                } ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <div class="label p-2 label-table label-success">Handover
                                                                    <?php if ($row['status_id'] == 6) {
                                                                        echo 'In-Pipeline';
                                                                    } else {
                                                                        echo 'Completed';
                                                                    } ?>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group">
                                                                        <span id="thisstatus"
                                                                            ...
                                                                            aria-expanded="false">Azione</span>
                                                                        <div class="dropdown-menu animated flipInY">
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="delete_handover('<?php echo $row[0]; ?>');">Eliminare</a>
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="duplicate_handover('<?php echo $row[0]; ?>');">Duplicare</a>
                                                                            <a class="dropdown-item"
                                                                                href="handover_detail.php?id=<?php echo $row[0]; ?>">Visualizza</a>
                                                                            <a class="dropdown-item"
                                                                                href="handover_edit.php?id=<?php echo $row[0]; ?>">Modificare</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            <?php } ?>
                                                            <td class="text-center">
                                                                <b><?php echo date("d.m.Y", strtotime(substr($row[13], 0, 10))); ?></b><br><span
                                                                    class="label-light-gray"><?php echo substr($row[13], 10); ?></span>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
