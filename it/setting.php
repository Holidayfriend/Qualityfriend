                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info waves-effect"
                                                onclick="update_language()">Salva</button>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title black_color" id="myModalLabel"><i
                                                    class="fa fa-sticky-note"></i> Crea il testo di
                                                benvenuto<br><small>Lunghezza massima ccnsigliata del testo 300
                                                    caratteri</small></h4>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-hidden="true">×</button>
                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Lunedi <small>(Predefinito se gli altri giorni
                                                                            sono vuoti.)</small></h6>
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Inserisci Nota" maxlength="300">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Martedì</h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" id="mon_note_id_it"
                                                                        ...
                                                                        class="form-control mb-2"
                                                                        placeholder="Inserisci Nota in italiano"
                                                                        maxlength="300">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Martedì</h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <input type="text" id="mon_note_id_de"
                                                                        ...
                                                                        class="form-control mb-2"
                                                                        placeholder="Inserisci la nota in tedesco"
                                                                        maxlength="300">
                                                                    <h6 class="font-weight-title black_color mb-1">
                                                                        Martedì</h6>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info waves-effect"
                                                onclick="update_welcome_note()">Salva</button>
                                            <button type="button" class="btn btn-default waves-effect"
                                                data-dismiss="modal">Annulla</button>
                                        </div>
                                    </div>
                                                ...
                                                if ($Edit_rules == 1 || $usert_id == 1) { ?>
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-10 col-xlg-10 col-md-9">
                                                                <h4 class="pt-3 black_color">Gestisci ruoli </h4>
