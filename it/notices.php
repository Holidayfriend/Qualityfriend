            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    ...
                    if ($Create_edit_notices == 1 || $usert_id == 1) {
                        ...
                        $sql = "SELECT a.* FROM `tbl_note` AS a  WHERE a.`is_delete` = 0 AND a.`hotel_id` = $hotel_id AND a.saved_status = 'CREATE' $filterConditions";
                        $sqlCount = "SELECT COUNT(*) AS total FROM `tbl_note` AS a WHERE a.`is_delete` = 0 AND a.`hotel_id` = $hotel_id AND a.saved_status = 'CREATE'  $filterConditions";
                    } else {
                        // SQL for users with restricted access
                        $sql = "SELECT DISTINCT a.* FROM `tbl_note` as a LEFT OUTER JOIN tbl_note_recipents as b ON a.nte_id=b.nte_id LEFT OUTER JOIN tbl_note_departments as c on a.nte_id=c.nte_id WHERE a.`hotel_id` = $hotel_id AND a.is_delete = 0 AND a.saved_status = 'CREATE' AND a.is_active = 1 AND (b.user_id=$user_id OR c.depart_id = $depart_id)
                        $filterConditions";

                        $sqlCount = "SELECT COUNT(DISTINCT a.nte_id) AS total 
        FROM `tbl_note` AS a 
        LEFT OUTER JOIN tbl_note_recipents AS b ON a.nte_id = b.nte_id 
        LEFT OUTER JOIN tbl_note_departments AS c ON a.nte_id = c.nte_id 
          ...
          AND (b.user_id = $user_id OR c.depart_id = $depart_id)
                ...
                <div class="row pr-4 mobile-container-padding">
                    ...
                    if ($notices_flag == 1) {
                        ?>
                        <div class="col-lg-12-custom pr-0">
                            <div class="list-background-active icon text-center padding-top-8"
                ...
                <div class="row pl-3 pr-3">
                    ...
                    <div class="col-lg-2 wm-48 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_notices == 1 || $usert_id == 1) { ?>
                            <a href="notice_create.php" class="btn  w-100 btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Creare Notizie</a>
                        <?php } ?>
                    </div>
                                                    ...
                                                    <tr>
                                                        <td class="text-center"><b><?php echo $title; ?></b><br>
                                                            <div class="label pl-4 pr-4 label-table btn-info cursor-pointer"
                                                                onclick="redirect_url('notice_detail.php?id=<?php echo $row[0]; ?>');">
                                                                Notizie</div>
                                                        </td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="label p-2 label-table label-success">Notizie
                                                                <?php echo $row['saved_status']; ?>
                                                            </div>
                                                        </td>
                                                        <?php if ($Create_edit_notices == 1 || $usert_id == 1) { ?>
                                                            <td class="text-center">
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu animated flipInY">
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            onclick="delete_notice('<?php echo $row[0]; ?>');">Eliminare</a>
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            onclick="duplicate_notice('<?php echo $row[0]; ?>');">Duplicare</a>
                                                                        <a class="dropdown-item"
                                                                            href="notice_detail.php?id=<?php echo $row[0]; ?>">Visualizza</a>
                                                                        <a class="dropdown-item"
                                                                            href="notices_edit.php?id=<?php echo $row[0]; ?>">Modificare</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        <?php } ?>
                                                        <td class="text-center">
                                                            <b><?php echo date("d.m.Y", strtotime(substr($row[15], 0, 10))); ?></b><br><span
                                                                class="label-light-gray"><?php echo substr($row[15], 10); ?></span>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
