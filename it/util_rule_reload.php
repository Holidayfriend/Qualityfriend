...
<div class="modal-header">
    <h4 class="modal-title m-2" id="teamModalLabel">Ruoli</h4>
...
function getRuleDescription($ruleKey)
{
    ...
    $rules = [
        'rule_1' => 'Creare e modificare checklists e todo lists',
        'rule_2' => 'Creare e modificare manuali',
        'rule_3' => 'Creare e modificare riparazioni',
        'rule_4' => 'Creare e modificare appunti',
        'rule_5' => 'Creare e modificare handovers',
        'rule_6' => 'Creare e modificare utenti,team e dipartimenti',
        'rule_7' => 'Ricevere e mandare messaggi',
        'rule_8' => 'Creare e modificare ruoli',
        'rule_12' => 'Gestisci gli orari',
        'rule_15' => 'Amministrazione stipendi',
        'rule_16' => 'Budget & Forecast',
        'rule_13' => 'Housekeeper',
        'rule_14' => 'Housekeeping Admin',
        'rule_9' => 'Creare e modificare annunci di lavoro',
        'rule_10' => 'Creare e modificare candidati',
        'rule_11' => 'Creare e modificare collaboratori',
        'rule_17' => 'Creare e modificare orari di lavoros',
    ];
