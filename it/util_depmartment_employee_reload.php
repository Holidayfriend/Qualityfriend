...
if ($base == 'team') {
    ...
    <div class="modal-header">
        <h4 class="modal-title" id="teamModalLabel">Dipendenti all'interno <?php echo $team_name ?></h4>
...
<?php } else if ($base == 'department') {
    ...
    ?>
        <div class="modal-header">
            <h4 class="modal-title" id="teamModalLabel">Dipendenti all'interno <?php echo $department_name ?></h4>
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        </div>
