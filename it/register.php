    ...
    <div class="register-container">
        ...
        <div class="right-section">
            <form id="registerForm">
                ...
                <div class="form-group">
                    <input type="text" id="firstname" class="form-control" placeholder="Nome di battesimo">
                </div>
                <div class="form-group">
                    <input type="text" id="lastname" class="form-control" placeholder="Cognome">
                </div>
                <div class="form-group">
                    <input type="text" id="company_name" class="form-control" placeholder="Nome dell'azienda">
                </div>
                <div class="form-group">
                    <input type="text" id="hotel_name" class="form-control" placeholder="Nome dell'hotel">
                </div>


                <div class="form-group">
                    <input type="email" id="email" class="form-control" placeholder="Indirizzo e-mail">
                ...
                <div class="form-group">
                    <input type="tel" id="phone_number" class="form-control" placeholder="Numero di telefono (facoltativo)">
                </div>
                ...
                <div class="form-group">
                    <input type="text" id="city" class="form-control" placeholder="Città">
                </div>
                <div class="form-group">
                    <input type="text" id="address" class="form-control" placeholder="Indirizzo">
                </div>
                <div class="form-group">
                    <input type="text" id="street_address" class="form-control" placeholder="Via e numero">
                </div>

                <div class="form-group">
                    <input type="text" id="postal_code" class="form-control" placeholder="Zip / Codice postale">
                </div>



                <div class="form-group">
                    <input type="text" id="vat_id" class="form-control" placeholder="VAT ID (Opzionale)">
                </div>
                ...
                <div class="form-group">
                    <div class="checkbox-container">
                        ...
                        <label for="terms">
                            Ich akzeptiere die <a href="https://www.holidayfriend.solutions/it/terms" target="_blank">Nutzungsbedingungen</a> und die <a href="https://www.holidayfriend.solutions/it/privacy" target="_blank">Datenschutzrichtlinie</a>
                ...
                <div class="text-center mt-4">
                    <button type="button" id="registerBtn" class="btn register-btn text-white">Registro</button>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#registerBtn').click(function() {
                ...
                if (!terms) {
                    $('#terms-error').text('Devi accettare i Termini di Servizio e l Informativa sulla Privacy.');
                    isValid = false;
                }
                if (!logo_file) {
                ...
                if (isValid) {
                    ...
                    formData.append('hotel_language', 'IT');
