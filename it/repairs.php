            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    ...
                    if ($Create_edit_repairs == 1 || $usert_id == 1) {
                        ...
                        $sql = "SELECT a.* FROM `tbl_repair` AS a  WHERE a.`hotel_id` = $hotel_id AND a.status_id = 6 and a.is_delete = 0 and a.saved_status = 'CREATE' $filterConditions";
                        $sqlCount = "SELECT COUNT(*) AS total FROM `tbl_repair` AS a  WHERE a.`hotel_id` = $hotel_id AND a.status_id = 6 and a.is_delete = 0 and a.saved_status = 'CREATE'  $filterConditions";
                    } else {
                        // SQL for users with restricted access
                        $sql = "SELECT DISTINCT a.* FROM `tbl_repair` as a LEFT OUTER JOIN tbl_repair_recipents as b ON a.rpr_id=b.rpr_id LEFT OUTER JOIN
                         tbl_repair_departments as c on a.rpr_id=c.rpr_id WHERE a.`hotel_id` = $hotel_id AND status_id = 6 AND a.is_delete = 0 AND a.saved_status = 'CREATE'
                        AND a.is_active = 1 AND (b.user_id=$user_id OR c.depart_id = $depart_id)
                        $filterConditions";
                ...
                <div class="row pl-3 pr-3">
                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_repairs == 1 || $usert_id == 1) { ?>
                            <a href="repair_create.php" class="btn w-100 wm-48 btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Creare riparazione</a>
                        <?php } ?>
                    </div>
                                                ...
                                                while ($row = mysqli_fetch_array($result10)) {
                                                    ...
                                                    if ($is_completed == 0) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="label p-2 label-table label-success">Riparazione
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu animated flipInY">
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="delete_repair('<?php echo $row[0]; ?>');">Eliminare</a>
                                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                                onclick="duplicate_repair('<?php echo $row[0]; ?>');">Duplicare</a>
                                                                            <a class="dropdown-item"
                                                                                href="repair_detail.php?id=<?php echo $row[0]; ?>">Visualizza</a>
                                                                            <a class="dropdown-item"
                                                                                href="repair_edit.php?id=<?php echo $row[0]; ?>">Modificare</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            <?php } ?>
