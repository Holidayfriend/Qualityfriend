                                ...
                                <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                    <li class="nav-item w-180-custom wm-50px"> <a class="nav-link active"
                                            data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i
                                                    class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Ore
                                                lavorate</span> </a> </li>
                                    <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab"
                                            href="#profile3" role="tab"><span class="hidden-sm-up"><i
                                                ...
                                                class="hidden-xs-down">Scheda attività dei dipendenti</span></a> </li>
                                    <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab"
                                            href="#messages13" role="tab"><span class="hidden-sm-up"><i
                                                    class="fas fa-hand-holding"></i></span> <span
                                                class="hidden-xs-down">Vacanze</span></a> </li>
                                    <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab"
                                            href="#messages3" role="tab"><span class="hidden-sm-up"><i
                                                    class="fas fa-dollar-sign"></i></span> <span
                                                class="hidden-xs-down">Pool di turni</span></a> </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content w-100">
                                    <div class="tab-pane active" id="home3" role="tabpanel">
                                        <div class="row pl-1">
                                            <div class="col-lg-7">
                                                ...
                                                <span>Una visualizzazione dettagliata delle ore lavorate da un
                                                    dipendente</span>
                                                <br>
                                                <label class="control-label mt-4"><strong>Intervallo di
                                                        date</strong></label>
                                                ...
                                                <div class="row mt-3">
                                                    <?php if ($wage_admin == 1 || $usert_id == 1) { ?>
                                                        <div class="col-lg-4">
                                                            <label
                                                                class="control-label"><strong>Dipartimento</strong></label>
                                                            <select id="1_select2" class="form-control custom-select">
                                                                <option value="0" disabled selected>Seleziona Dipartimento
                                                                </option>
                                                                <?php
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <select id="1_select1" class="form-control custom-select">
                                                            <option value="0" disabled selected>Seleziona un dipendente
                                                            </option>
                                                            <?php
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 mt-3">
                                                        <label class="control-label"><strong>Tipo di
                                                                esportazione</strong></label>
                                                    ...
                                                    <div class="col-lg-4 mt-3">
                                                        <input type="button" onclick="get_report_workedHours();"
                                                            class="btn mt-4 w-100 btn-info" value="Ottieni rapporto">
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="profile3" role="tabpanel">
                                        <div class="row pl-1">
                                            <div class="col-lg-4">
                                                ...
                                                <span>Una visualizzazione dettagliata delle ore di turno di un
                                                    dipendente</span>
                                                <br>
                                                <label class="control-label mt-4"><strong>Intervallo di
                                                        date</strong></label>
                                                ...
                                                <label class="control-label mt-3"><strong>Tipo di
                                                        esportazione</strong></label>
                                                ...
                                                <input type="button" onclick="get_report_emp_timesheet();"
                                                    class="btn mt-5 w-30 btn-info" value="Ottieni rapporto">
                                    ...
                                    <div class="tab-pane" id="messages13" role="tabpanel">
                                        <div class="row pl-1">
                                            <div class="col-lg-4">
                                                <h3>Tempo scaduto</h3>
                                                <span>Una visualizzazione dettagliata dei giorni liberi approvati per
                                                    dipendente, incluso chi ha approvato la richiesta</span>
                                                <br>
                                                <label class="control-label mt-4"><strong>Intervallo di
                                                        date</strong></label>
                                                <div class="input-group">
                                    ...
                                    <div class="tab-pane" id="messages3" role="tabpanel">
                                        <div class="row pl-1">
                                            <div class="col-lg-4">
                                                ...
                                                <label class="control-label mt-3"><strong>Turno offerto dal
                                                        dipendente</strong></label>
                                                ...
                                                <label class="control-label mt-3"><strong>Turno offerto al
                                                        dipendente</strong></label>
