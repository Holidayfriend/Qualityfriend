                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal form-material" onsubmit="event.preventDefault();">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Vecchia Password" name="old_password" id="old_password" class="form-control form-control-line new_password">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="example-email" class="col-md-12">Nuova Password</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Nuova Password" class="form-control form-control-line new_password" name="new_password" id="new_password new_password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Confermare Nuova Password" class="form-control form-control-line new_password" name="confirm_new_password" id="confirm_new_password">
                                                    </div>
                                                </div>
