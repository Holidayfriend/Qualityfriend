...
<div class="form-group mb-0 black_color">
    <label class="control-label display-inline w-80 wm-50 black_color"><strong>Titolo del dipartimento del personale</strong></label>
    <label class="control-label display-inline w-18 wm-50 black_color"><strong>Azione</strong></label>
</div>
<?php
