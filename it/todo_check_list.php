                    ...
                    <div class="col-lg-2 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_todo_checklist == 1 || $usert_id == 1) { ?>
                            <a href="create_todo_checklist.php" class="btn btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i>Aggiungere Todo/Checklist</a>
                        <?php } ?>
                    </div>
                    <?php
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group">
                                                                        <span id="thisstatus"
                                                                            ...
                                                                            aria-expanded="false">Azioni</span>

                                                                        <div class="dropdown-menu animated flipInY">
                                                                            <a class="dropdown-item" onclick="d(<?php echo $tdl_id; ?>)"
                                                                                href="javascript:void(0)">Eliminare</a>
                                                                            <a class="dropdown-item"
                                                                                onclick="duplicate(<?php echo $tdl_id; ?>)"
                                                                                href="javascript:void(0)">Duplicare</a>
                                                                            <a class="dropdown-item"
                                                                                href="todo_check_list_detail.php?id=<?php echo $row['tdl_id']; ?>">Visualizza</a>
                                                                            <a class="dropdown-item"
                                                                                href="edittodo_check_list.php?id=<?php echo $row['tdl_id']; ?>">Modificare</a>
