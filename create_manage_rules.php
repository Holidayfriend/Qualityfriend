...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Manage Roles</p>
        </div>
    </div>
            ...
            <div class="container-fluid mobile-container-pl-75 pr-0" id="mcontainer">
                ...
                <div class="row page-titles pb-0">
                    <div class="col-md-3 align-self-center">
                        <h4 class="text-themecolor font-weight-title font-size-title">Manage Roles</h4>
                    </div>
                    <div class="col-md-7">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-info waves-effect"
                                                onclick="save_user_type()">Save</button>
                                            <button type="button" class="btn btn-default waves-effect"
                                                data-dismiss="modal">Cancel</button>
                                        </div>
                                    </div>
                            ...
                            <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-info waves-effect"
                                                onclick="save_edit_user_type()">Save</button>
                                            <button type="button" class="btn btn-default waves-effect"
                                                data-dismiss="modal">Cancel</button>
                                        </div>
                                    </div>
