                    ...
                    <div class="col-lg-2 wm-48 col-md-3 mt-2 mb-3">
                        <?php if ($Create_edit_notices == 1 || $usert_id == 1) { ?>
                            <a href="notice_create.php" class="btn w-100 btn-secondary d-lg-block "><i
                                    class="fa fa-plus-circle"></i> Create Notice</a>
                        <?php } ?>
                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result10)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="label p-2 label-table label-success">Notice
                                                                <?php echo $row['saved_status'] === 'CREATE' ? 'Created' : $row['saved_status']; ?>
                                                            </div>
                                                        </td>
                                                        <?php if ($Create_edit_notices == 1 || $usert_id == 1) { ?>
                                                            <td class="text-center">
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu animated flipInY">
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            onclick="delete_notice('<?php echo $row[0]; ?>');">Delete</a>
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            onclick="duplicate_notice('<?php echo $row[0]; ?>');">Duplicate</a>
                                                                        <a class="dropdown-item"
                                                                            href="notice_detail.php?id=<?php echo $row[0]; ?>">View</a>
                                                                        <a class="dropdown-item"
                                                                            href="notices_edit.php?id=<?php echo $row[0]; ?>">Edit</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        <?php } ?>
