        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mobile-container-padding heading_style">
                    ...
                    $sqlCount = "SELECT COUNT(*) AS total FROM `tbl_todolist` WHERE  hotel_id = $hotel_id AND `is_delete` = 0 AND `saved_status` = 'DRAFT'";
                    ...
                    $sql .= " ORDER BY `tdl_id` DESC LIMIT $offset, $recordsPerPage";
...
-->
                                                        ...
                                                        <td class="font-size-subheading text-center"><a
                                                                href="edittodo_check_list.php?id=<?php echo $row['tdl_id']; ?>"><i
