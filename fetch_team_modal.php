...
<div class="modal-header">
    <h4 class="modal-title" id="teamModalLabel">Employees in <?php echo $team_name ?></h4>
            ...
            <div class="tab-pane active" role="tabpanel">
                <div class="form-group">
                    <div class="col-md-12 m-b-20 mt-2">
                        <select  onchange="update_team(this.value,<?php echo $team_id;  ?>)" id="user_id_d" name="empname" class="select2 form-control" style="width: 100%">
